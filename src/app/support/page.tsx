...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    category: "🧍 姿勢チェック",
    q: "無料で何回まで使える？",
    a: "ご登録後、7日間の無料トライアルですべての機能をお試しいただけます。トライアル終了後、AI機能（姿勢チェック・AIチャット・食事分析）のご利用にはプレミアムプランへのご登録が必要です。なお、これまでの記録やお写真、ストレッチの内容は引き続きご覧いただけます。※ 2026年9月13日より前にご登録いただいた方は、従来どおりの無料枠（姿勢チェック月3回・AIチャット月5回・食事分析月3回）をそのままご利用いただけます。",
  },
  // AIカウンセラー
  {
    category: "🦴 ガイコツ先生（AI）",
