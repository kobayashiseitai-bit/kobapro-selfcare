...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    category: "💳 サブスク・課金",
    q: "無料トライアル後の課金タイミングは？",
    a: "3日間の無料トライアル終了時に自動的に有料プランへ切り替わります。トライアル中に解約すれば課金は発生しません。Apple App Storeの規約に従い、トライアル終了24時間前までに解約手続きをお願いします。",
  },
  {
    category: "💳 サブスク・課金",
    q: "返金を希望します",
  ...
  },
  {
    category: "💳 サブスク・課金",
    q: "月額と年額、どちらがお得ですか？",
    a: "年額プラン（¥8,800/年）は月額プラン（¥880/月）と比較して月額換算 ¥733 となり、約17%（2ヶ月分）お得です。長期継続を予定されている方には年額プランをおすすめします。",
  },
  // 姿勢チェック
  {
    category: "🧍 姿勢チェック",
  ...
  },
  {
    category: "🧍 姿勢チェック",
    q: "無料で何回まで使える？",
    a: "ご登録後、3日間の無料トライアルですべての機能をお試しいただけます。トライアル終了後、AI機能（姿勢チェック・AIチャット・食事分析）のご利用にはプレミアムプランへのご登録が必要です。なお、これまでの記録やお写真、ストレッチの内容は引き続きご覧いただけます。※ 2026年9月13日より前にご登録いただいた方は、従来どおりの無料枠（姿勢チェック月3回・AIチャット月5回・食事分析月3回）をそのままご利用いただけます。",
  },
  // AIカウンセラー
  {
    category: "🦴 ガイコツ先生（AI）",
